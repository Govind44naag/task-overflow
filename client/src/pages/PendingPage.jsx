...
const PendingPage = () => {
  ...
  const sortedPendingTasks=useMemo(()=>{
    ...
    return filtered.sort((a,b)=>{
      ...
      const older={high:3,medium:2,low:1}
    return older[b.priority.toLowerCase()]-older[a.priority.toLowerCase()]
    })
  },[tasks,sortBy])
  return (
     <div className={layoutClasses.container}>
      ...
      <div className={layoutClasses.addBox} onClick={()=>setShowModel(tru)}>
      ...
      <TaskModel isOpen={!!selectedTask || showModel}
