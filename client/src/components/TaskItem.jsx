...
return (
  <>
    <div
      className={`${TI_CLASSES.wrapper} ${borderColor} flex flex-row items-start justify-between gap-3 sm:gap-4 flex-wrap sm:flex-nowrap`}
    >
      {/* LEFT SECTION */}
      <div className={`${TI_CLASSES.leftContainer} flex flex-1 flex-col sm:flex-row sm:items-start gap-2 sm:gap-4 min-w-0`}>
        {/* Complete Checkbox */}
      ...
      {/* RIGHT SECTION */}
      <div className={`${TI_CLASSES.rightContainer} flex flex-col justify-start items-end gap-2 shrink-0`}>
